...
document.addEventListener('mousemove', function(e) {
  ...
  runtime.setSlotValue(rootLexEnv.inputA, mouseX, t);
  runtime.setSlotValue(rootLexEnv.inputB, mouseY, t);
...
function startDemoProg(prog) {
  ...
  runtime.setSlotValue(rootLexEnv.inputA, 0, 0);
  runtime.setSlotValue(rootLexEnv.inputB, 0, 0);
